...
```bash
bash <(curl -sL [https://raw.githubusercontent.com/SanakulovDev/init_go/main/init_go.sh](https://raw.githubusercontent.com/SanakulovDev/init_go/main/init_go.sh))
